...
export default class {
  constructor(platform, accessory) {
    ...
    // The MINI dimmer also reports power readings
    if (this.accessory.context.eweUIID === 277) {
    ...
    try {
      ...
      switch (this.accessory.context.eweUIID) {
        ...
        case 44:
          ...
          break
        case 277:
          params.brightness = Math.max(value, 1)
          params.switch = 'on'
          break
        case 57:
